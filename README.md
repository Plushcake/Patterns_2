[![Build status](https://ci.appveyor.com/api/projects/status/sjljujg4a1k7fpal/branch/main?svg=true)](https://ci.appveyor.com/project/Plushcake/patterns-2/branch/main)
...
* формат данных - JSON
* REST-assured
Мы крайне настоятельно рекомендуем ознакомиться с документацией и примерами на [Rest Assured](https://rest-assured.io/).
...
Подсказка. Как подключить Lombok?
